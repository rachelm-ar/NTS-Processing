...
# Car pa to od
car_pa_to_od <- pa_to_od %>%
  filter(mode_from_home == 3) %>%
  filter(mode_to_home == 3) %>%
...
car_pa_to_od %>% write_csv('car_pa_to_od.csv')