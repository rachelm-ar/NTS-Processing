...
hb_csv <- hb_csv %>% 
  select(age_work_status, gender, hh_adults, cars, soc_cat, ns_sec, tfn_area_type, trip_purpose, weekly_trips, trip_weights) %>% 
...
write_csv(trip_rates_out, "C:/Users/Pluto/Documents/Trip_rate_testing/hb_trip_rates_v3.2.csv")
