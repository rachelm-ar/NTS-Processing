...
worker_covars <- c("gender", "hh_type", "soc", "ns", "tfn_area_type")
child_covars <- c("hh_type", "ns", "tfn_area_type")
non_worker_covars <- c("gender", "hh_type", "ns", "tfn_area_type")
...
write_csv(hb_trip_rates, "C:/Users/Pluto/Documents/NTS_C/outputs/hb/hb_trip_rates/hb_trip_rates.csv")
