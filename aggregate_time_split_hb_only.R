### Organising NTS data and calculate time period share of one-way trips (AM, IP, PM, OP), hb trips only ###
...
#### Calculate time period share of one-way trips and export ####
...
time_period_share %>% write_csv("Y:/NTS/mode_time_splits/aggregate_time_split_hb_only.csv")
