...
# 2) apply soc classification only apply for trip purposes 1 & 2? - necessary?
...
# 6) trip rate calculations?




### required for trip rate calculations:
#PSUID
#HouseholdID
#IndividualID 
##OutCom_B02ID
