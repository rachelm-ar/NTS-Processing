...
lookups_dir <- str_c("C:/Users/Pluto/Documents/GitHub/NTS-Processing/lookups.R")
...
if(save_processed) write_csv(unclassified_build, "C:/Users/Pluto/Documents/NTS/classified_build.csv")
...
if(version == "hb_trip_rates"){
  ...
  write_csv(classified_build_weight, "C:/Users/Pluto/Documents/NTS/hb_trip_rates_build.csv")
  ...
  write_csv(car_availability, "C:/Users/Pluto/Documents/NTS/car_availability_build.csv")
